...
public class DonutProgress extends View {
    ...
    private final int default_finished_color = Color.parseColor("#FFFFFF");
    private final int default_unfinished_color = Color.parseColor("#e1e0d7");
    private final int default_text_color = Color.parseColor("#615f55");
