...
public class Session {
    ...
    void advance(String response) {
        if ((response.equals(ca) && (getCurrquest() != 18))) {
            ...
            if (currquest < 8) {
                q = getQuestion(2);
                System.out.println("Get question(2)");
            } else if (currquest < 12) {
                q = getQuestion(3);
                System.out.println("Get question(3)");
            } else if (currquest < 15) {
                q = getQuestion(4);
                System.out.println("Get question(4)");
            } else if (currquest > 14) {
                q = getQuestion(5);
                System.out.println("Get question(5)");
            }
            setParams(q);
        } else {
            flag = 1;
